...
{
    struct NavigationParam : NavigationParamT<NavigationParam>
    {
    private:
...
{
    struct NavigationParam : NavigationParamT<NavigationParam, implementation::NavigationParam>
    {
    };
}
